...
function mortgageCalculator(P, I ,N){
    return name + ", your monthly rate is $" + P*[I*(1+I)**N]/[(1+I)**N-1];
}
...
function mortgageCalculator1(P, I ,N){
    ...
    return name + ", your monthly rate is $"+ P*numerator/denominator;
}

//console.log(mortgageCalculator1(200000,0.05,30))
...
function mortgageCalculator2(P, I ,N,creditScore){
    let monthly= I/12
    if (creditScore>750){
        var int =monthly*0.95
    }
    else if (creditScore<660){
        var int =monthly*1.05
    }
    else {
        var int =monthly*1
    }
    let periods = N*12
    let n1=(1+int)**periods
    const numerator = (int)*n1
    const denominator = n1-1
    
    return name + ", your monthly rate is $"+ P*numerator/denominator;
}

//console.log(mortgageCalculator2(200000,0.05,30,200));
